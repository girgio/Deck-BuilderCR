...
\caption*{DECK 1: Soluzione pessima, deck sbilanciato e troppo costoso (fitness = 188).}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{images/DeckMigliore.png}
\caption*{DECK 2: Soluzione buona, deck equilibrato e con costo moderato (fitness = 180).}
\end{figure}
...
\medskip
Il dominio dei valori di \textit{DannoMedio} e \textit{VitaMedia} è significativamente differente, come mostrato nel Grafico~1. 
...
\medskip
{GRAFICO 1: Distribuzione dei valori di DannoMedio e VitaMedia}
...
\par
{GRAFICO 2: Distribuzione normalizzata dei valori di VitaMedia}
...
\begin{itemize}
    \item \textit{VitaMedia}: rappresenta la quantità media di punti vita delle truppe nel deck ed è una misura della capacità di resistenza difensiva.
